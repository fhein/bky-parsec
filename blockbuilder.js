function JsonBlockBuilder(defaultExtensions) {
...
JsonBlockBuilder.prototype.get = function() {
  ...
  this.block.extensions = [...new Set([...this.block.extensions, ...this.defaultExtensions])];
