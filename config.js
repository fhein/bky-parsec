...
Config.defaultExtensions = ['register_generator'];
...
Config.getBlocks = function() {
  ...
  console.log('Extensions in use: ' + JSON.stringify(this.extensions));
  return json;
}
...
Config.setup = function() {
  ...
  this.jbb = new JsonBlockBuilder(this.defaultExtensions);
  this.setupMessages();
  return {
